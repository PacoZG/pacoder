...
const Strenghts = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-400 via-gray-50 to-gray-400 flex flex-col items-center">
      <div className="p-6 w-2/3 text-center">
        ...
        <div className="p-4 border-2 border-black rounded-md bg-yellow-600 mb-3">
          <div className="flex items-center justify-between">
        ...
        <div className="p-4 border-2 border-black rounded-md bg-blue-700 mb-3">
          <div className="flex items-center justify-between">
            <p className="text-2xl text-white cursor-pointer pb-2 text-left" onClick={() => setStgr3(!stgr3)}>
              Academic experience
            </p>
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <p className="text-white border-t-2 border-white pt-2">
        ...
        <div className="p-4 border-2 border-black rounded-md bg-yellow-100">
          <div className="flex items-center justify-between">
            <p className="text-2xl text-black cursor-pointer pb-2 text-left font-bold" onClick={() => setStgr4(!stgr4)}>
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <p className="text-black border-t-2 border-white pt-2">
              Click{' '}
              <a
                className="text-indigo-600 hover:text-red-800 hover:underline"
