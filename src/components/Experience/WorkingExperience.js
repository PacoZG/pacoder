...
const WorkingExperience = () => {
  ...
  return (
    // Main container background already consistent, no change needed here
    <Div className=" flex flex-col items-center justify-center bg-gray-400 dark:bg-gray-900 rounded-b-xl p-4 py-10 md:py-14 lg:py-16 transition duration-500 bg-opacity-70 dark:bg-opacity-70 min-h-auto">
      ...
      <WorkingCompany experience={getWorkingCompany(2)} /> {/* Assuming no link for this entry */}
      <WorkingCompany experience={getWorkingCompany(1)} /> {/* Assuming no link for this entry */}
    </Div>
  )
}
