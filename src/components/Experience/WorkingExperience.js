...
const WorkingExperience = () => {
  ...
  return (
    <Div className=" flex flex-col items-center justify-center bg-gray-400 dark:bg-gray-900 rounded-b-xl p-4 md:py-10 lg:py-20 transition duration-500 bg-opacity-70 dark:bg-opacity-70 min-h-screen">
