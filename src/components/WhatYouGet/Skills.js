        ...
        <Div className="md:hidden block">
          <Div className="flex flex-col items-center space-y-3 sm:space-y-8 md:space-y-12">
            ...
            <Div className="flex items-center justify-evenly space-x-12">
              ...
              <Div className="flex flex-col items-center">
                <DockerLogo className="skill-logo p-3 my-2 bg-gray-50 bg-opacity-10" />
      ...
      <Div className="flex flex-col md:flex-row justify-center md:w-full gap-2 sm:gap-4 md:gap-16 xl:gap-10 pt-5">
        <Div className="flex flex-col xl:flex-row gap-2 sm:gap-4 md:gap-6 xl:gap-10  ">
          <Div className="flex items-center gap-4 md:gap-0">
            <PuzzleIcon className="w-5 h-5 text-black dark:text-gray-300 " />

            <P className="md:px-5 text-black dark:text-gray-300 text-xs sm:text-sm uppercase transition duration-500">
              {t('skills.multitask')}
            </P>
          </Div>

          <Div className="flex items-center gap-4 md:gap-0">
            <LightBulbIcon className="w-5 h-5 text-black dark:text-gray-300 " />
        ...
        <Div className="flex flex-col xl:flex-row gap-2 sm:gap-4 md:gap-6 xl:gap-10  ">
          <Div className="flex items-center gap-4 md:gap-0">
            <TranslateIcon className="w-5 h-5 text-black dark:text-gray-300 " />
