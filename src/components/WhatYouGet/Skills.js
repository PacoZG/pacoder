      ...
      <Div className="flex flex-col justify-center lg:space-x-28 border-double border-b-8 border-gray-700 dark:border-gray-500  pb-12 lg:w-10/12">
        <Div className="hidden lg:flex flex-col space-y-9">
          ...
          <Div className="flex items-center justify-evenly gap-24">
            ...
            <Div className="flex flex-col items-center">
              <Cypress className="skill-logo h-24 " />
        ...
        <Div className="lg:hidden block">
          <Div className="flex flex-col items-center space-y-4 sm:space-y-8 md:space-y-12">
            ...
            <Div className="flex items-center justify-evenly space-x-9 sm:space-x-16 md:space-x-24">
              <Div className="flex flex-col items-center">
                <Img
                  className="skill-logo bg-green-400 p-2 md:h-28 "
                  src="https://img.icons8.com/color/96/000000/nodejs.png"
                  alt="React"
                />
              ...
              <Div className="flex flex-col items-center">
                <Img alt="tailwind-logo" src={Tailwind} className="skill-logo h-20 w-24 mb-4 pt-3 md:h-20 md:w-24" />
                <P className="text-sm text-black dark:text-blue-300 transition duration-500">Tailwindcss</P>
              </Div>
              <Div className="flex flex-col items-center">
                <Cypress className="skill-logo h-20 w-20 md:h-24 md:w-24" />
            ...
            <Div className="flex items-center justify-evenly space-x-9 sm:space-x-16 md:space-x-24">
              <Div className="flex flex-col items-center">
                <Typescript className="skill-logo w-20 my-2 rounded-none md:h-24 md:w-24" />
                <P className="text-sm text-black dark:text-green-400 transition duration-500">Typescript</P>
              </Div>
              <Div className="flex flex-col items-center">
                <AWSLogo className="skill-logo p-3 my-2 h-20 w-20 md:h-24 md:w-24 bg-white" />
                <P className=" text-center text-yellow-400 transition duration-500">Junior</P>
              </Div>
              <Div className="flex flex-col items-center">
