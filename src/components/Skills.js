...
const Skills = () => {
  return (
    <div className="p-16 bg-green-100">
      <div className="flex flex-wrap space-x-28 border-double border-b-8 border-gray-300 pb-12">
        <div className="flex flex-col items-center ">
          <img className="skill-logo bg-yellow-200 " src="https://img.icons8.com/nolan/96/javascript.png" alt="JS" />
          <p className="text-yellow-500">Javascript</p>
        </div>
        <div className="flex flex-col items-center ">
          <img
            className="skill-logo bg-gray-600  "
        ...
        <div className="flex flex-col items-center">
          <img className="skill-logo bg-white " src="https://img.icons8.com/color/96/000000/redux.png" alt="React" />
          <p className="text-purple-800">Redux</p>
        </div>
        <div className="flex flex-col items-center">
          <img className="skill-logo bg-white" src="https://img.icons8.com/nolan/96/react-native.png" alt="React" />
          <p className="text-pink-800">React-Native</p>
        </div>
        <div className="flex flex-col items-center">
          <img
            className="skill-logo bg-gray-300 "
        ...
        <div className="flex flex-col items-center">
          <img
            className="skill-logo bg-gray-200 "
        ...
        <div className="flex flex-col items-center">
          <img
            className="skill-logo bg-green-400 "
