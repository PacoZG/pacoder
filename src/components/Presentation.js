...
const Presentation = () => {
  ...
  return (
    <div className="flex flex-col items-center md:flex-row md:justify-center bg-gray-300 dark:bg-gray-900 p-3 pt-6 md:p-10 w-screen transition duration-300">
      <div className="flex flex-col items-center md:pl-20">
        <img
          className=" w-2/3 h-2/3 md:h-96 md:w-80 border-4 border-black dark:border-gray-300 rounded-xl transition duration-300 "
      ...
      <div className="p-10 md:pt-8 w-full md:w-3/4">
        ...
        <p className="text-gray-700 dark:text-gray-300 text-right text-xl transition duration-300">
